...
STARTUP := $(PLATFORM_PATH)/src/startup_stm32n657xx.S
HAL_SRCS :=
HAL_CORE := $(NUCLEO_N657X0_Q_PATH)/Drivers/STM32N6xx_HAL_Driver/Src/stm32n6xx_hal.c
...
EXTRA_SOURCES = \
    ...
    $(PLATFORM_PATH)/src/clock_config.c \
...
# The CMSIS and HAL files often fail compilation with strict warnings; relax for these files.
